...
enum { READING_REQUEST, SENDING_RESPONSE, READING_RESPONSE, SENDING_REQUEST,
	WRITE_BODY_TO_CGI, UPLOADING_FILE, DOWNLOADING_FILE, READING_HEADERS,
	READING_BODY, BODY_READY } ;
